...
exports.IYugiohswapExchange__factory = void 0;
var ethers_1 = require("ethers");
var IYugiohswapExchange__factory = /** @class */ (function () {
    function IYugiohswapExchange__factory() {
    }
    IYugiohswapExchange__factory.connect = function (address, signerOrProvider) {
        return new ethers_1.Contract(address, _abi, signerOrProvider);
    };
    return IYugiohswapExchange__factory;
}());
exports.IYugiohswapExchange__factory = IYugiohswapExchange__factory;
var _abi = [
    {
        anonymous: false,
        inputs: [
