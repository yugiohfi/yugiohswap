...
interface YugiohswapExchangeInterface extends ethers.utils.Interface {
  functions: {
...
export class YugiohswapExchange extends Contract {
  ...
  interface: YugiohswapExchangeInterface;
