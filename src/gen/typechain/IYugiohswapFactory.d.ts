...
interface IYugiohswapFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class IYugiohswapFactory extends Contract {
  ...
  interface: IYugiohswapFactoryInterface;
