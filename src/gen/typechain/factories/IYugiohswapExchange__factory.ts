...
import type { IYugiohswapExchange } from "../IYugiohswapExchange";

export class IYugiohswapExchange__factory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IYugiohswapExchange {
    return new Contract(address, _abi, signerOrProvider) as IYugiohswapExchange;
  }
}
