...
interface WrapAndYugiohswapInterface extends ethers.utils.Interface {
  functions: {
...
export class WrapAndYugiohswap extends Contract {
  ...
  interface: WrapAndYugiohswapInterface;
